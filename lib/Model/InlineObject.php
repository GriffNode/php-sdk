...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'error' => 'string',
        'message' => 'string',
        'existing_transaction' => '\CryptoGate\Model\InlineObjectAllOfExistingTransaction'
    ];
    ...
    protected static $setters = [
        ...
        'error' => 'setError',
        'message' => 'setMessage',
        'existing_transaction' => 'setExistingTransaction'
    ];
    ...
    protected static $getters = [
        ...
        'error' => 'getError',
        'message' => 'getMessage',
        'existing_transaction' => 'getExistingTransaction'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('existing_transaction', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets error
     *
     * @param string $error Machine-readable code.
     *
     * @return self
     */
    ...
    /**
     * Gets existing_transaction
     *
     * @return \CryptoGate\Model\InlineObjectAllOfExistingTransaction|null
     */
    public function getExistingTransaction()
    {
        return $this->container['existing_transaction'];
    }

    /**
     * Sets existing_transaction
     *
     * @param \CryptoGate\Model\InlineObjectAllOfExistingTransaction|null $existing_transaction existing_transaction
     *
     * @return self
     */
    public function setExistingTransaction($existing_transaction)
    {
        if (is_null($existing_transaction)) {
            throw new \InvalidArgumentException('non-nullable existing_transaction cannot be null');
        }
        $this->container['existing_transaction'] = $existing_transaction;
