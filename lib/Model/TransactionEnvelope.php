...
/**
 * TransactionEnvelope Class Doc Comment
 *
 * @category Class
 * @package  CryptoGate
 * @author   OpenAPI Generator team
 ...
 */
class TransactionEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionEnvelope';
    ...
    protected static $openAPITypes = [
        'success' => 'mixed',
        'data' => '\CryptoGate\Model\Transaction'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \CryptoGate\Model\Transaction $data data
     *
     * @return self
     */
